...
def test_simple():
    ...
    f_mask = np.zeros_like(initial_image) # np.load('/home/nathan/shuai_processed_data/shuai_data_mask.edf.npy')
    #N = f_image.shape[0]
    ...
    simulated_image, initial_cropped_image, mask = hiprmc.rmc(f_image, f_mask, N, T_MAX, iterations, load,)
